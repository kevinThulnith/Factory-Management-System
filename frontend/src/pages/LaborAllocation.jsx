            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-star-dust-400 text-1xl">
                  Track and manage employee work assignments with comprehensive
                  allocation tracking.
                </p>
                <div className="flex flex-wrap items-center justify-center sm:justify-start mt-3 gap-2">
                  ...
                  <span className="text-sm text-gray-200 px-3 py-1 rounded-2xl bg-purple-600">
                    Tasks:{" "}
                    <span className="font-medium">{stats.taskAllocations}</span>
                  </span>
                </div>
              </div>
            </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 mt-2">
                            ...
                            <span className="text-sm font-bold text-orange-400">
                              {parseFloat(alloc.hours_allocated).toFixed(2)} hrs
                            </span>
                          </div>
                        </div>
                      </div>
